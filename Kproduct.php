                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="<?php echo $row['image_path']?>" width="250" /> </div>
                            <div class="thumbnail text-center"> <img onclick="change_image(this)" src="<?php echo $row['image_path']?>" width="70"> <img onclick="change_image(this)" src="<?php echo $row['image_path']?>" width="70"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="Kproductcatalog.php">Back</a>
                            </div>
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><?php echo $row['category']?></span>
                                ...
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price">RM<?php echo $row['productPrice']?></span>
                                </div>
                            </div>
                            ...
                            <div class="cart mt-4 align-items-center"> <button onclick="window.location.href='Kpayment.php?productid=<?php echo urlencode($_GET['productid']); ?>'" class="btn btn-danger text-uppercase mr-2 px-4">Checkout</button>
